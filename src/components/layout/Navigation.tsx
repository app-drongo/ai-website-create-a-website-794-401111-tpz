        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl text-foreground">My Restaurant</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" size="sm" onClick={handleReservation}>
              Make Reservation
            </Button>
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t border">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              <Button variant="ghost" className="justify-start" onClick={handleReservation}>
                Make Reservation
              </Button>
